...
import {
  Interop_DeclarationTraverser as Import_Interop_DeclarationTraverser,
  Interop_ReferencedIdentifierTraverser as Import_Interop_ReferencedIdentifierTraverser,
